...
and classification (on the left in \Cref{fig-rl-process}) add a further
...
right in \Cref{fig-rl-process}), making the process simpler, more
...
%~\footnote{The raw data, additional figures and the source
%code required to run these experiments can be downloaded from: (link
...
\Cref{cora-quality} shows the precision, recall, and
...
% Peter: Figure is too high - higher than page hight! ************
% So I changed the \vspace{5mm} to \vspace{4mm} and made the plots less % wide ************
