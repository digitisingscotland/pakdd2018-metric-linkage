...
values. As expected, brute force and 
...
\caption{Cora - Traditional Blocking on `authors' field}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
\includegraphics[width=\textwidth]{figures/plotLQ-cora-trad-title}
\caption{Cora - Traditional Blocking on `title' field}
\end{subfigure}

\begin{subfigure}{.5\textwidth}
  \centering
\includegraphics[width=\textwidth]{figures/plotLQ-cora-trad-year}
\caption{Cora - Traditional Blocking on `publication year' field}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
...
\caption{Linkage results on Cora dataset}
\label{cora-quality}
\end{figure}
