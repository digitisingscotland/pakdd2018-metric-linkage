...
\emph{HARRA}~\cite{Kim10} is a record linkage approach based on Min-hash
[CITATION?] and LSH
...
\cite{Li2006} describes a threshold-based method of performing linkage
...
% Is next sentence necessary?
The approach achieved a recall of 99 percent in experiments in which
conjunctions of similarities over fields were used.
% Is this execution-time efficiency?
A later paper \cite{Ciaccia97indexingmetric} shows that M-trees are
